...
const Sell = ({ accounts, setAccounts }) => {  
  ...
  const handleSubmit = async (event) => {
    ...
    return (
<div class="container">
<br></br><h4>Sell your very own Phygital BeeToken!</h4><br></br>
<div class="row">
  <div class="col-sm">
    <div class="element">
  <p><br></br>Please fill in the ID and Price of your BeeToken.<br></br></p>
...
<div>
  ...
  <p><b>Attention!</b> You will need to confirm a second step in MetaMask after pressing Sell Phygital BeeToken.</p>
</div>
</div>
<div class="element"> 
