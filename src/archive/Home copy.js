  ...
  const [loading, setLoading] = useState(true);
   ...
   const loadItems = async() => {
    // Load all unsold items 
      ...
      const listedNFT = new ethers.Contract(phygitalEscrowAddress
      ,phygitalEscrowJson.abi, signer)
              ...
              <Card className="rounded">
                    ...
                    <Card.Footer>
                      <div className='d-grid'>
                        <button id="mintButton" onClick={event => window.location.href='/Buy'}>Buy NFT</button>
                      </div>
                    </Card.Footer>
                  </Card>
                  </Col>
